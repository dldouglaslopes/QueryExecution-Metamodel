 ...
 * </p>
 * <ul>
 *   <li>{@link query_metamodel.impl.QueryImpl#getMethod <em>Method</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QueryImpl extends MinimalEObjectImpl.Container implements Query {
	...
	protected EClass eStaticClass() {
		return Query_metamodelPackage.Literals.QUERY;
	}
	...
	public NotificationChain basicSetMethod(Method newMethod, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Query_metamodelPackage.QUERY__METHOD, oldMethod, newMethod);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newMethod != method) {
			...
			if (method != null)
				msgs = ((InternalEObject) method).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Query_metamodelPackage.QUERY__METHOD, null, msgs);
			if (newMethod != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Query_metamodelPackage.QUERY__METHOD, newMethod,
					newMethod));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case Query_metamodelPackage.QUERY__METHOD:
