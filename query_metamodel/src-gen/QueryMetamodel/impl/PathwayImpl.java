 ...
 *   <li>{@link QueryMetamodel.impl.PathwayImpl#getVersion <em>Version</em>}</li>
...
public class PathwayImpl extends MinimalEObjectImpl.Container implements Pathway {
	...
	public void setVersion(int newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Query_metamodelPackage.PATHWAY__VERSION, oldVersion,
					version));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Query_metamodelPackage.PATHWAY__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case Query_metamodelPackage.PATHWAY__QUANTITY:
			return getQuantity();
		case Query_metamodelPackage.PATHWAY__VERSION:
			return getVersion();
