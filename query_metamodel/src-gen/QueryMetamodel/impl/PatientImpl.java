...
public class PatientImpl extends MinimalEObjectImpl.Container implements Patient {
	...
	protected EClass eStaticClass() {
		return Query_metamodelPackage.Literals.PATIENT;
	}
	...
	public void setCode(int newCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Query_metamodelPackage.PATIENT__CODE, oldCode, code));
	}
	...
	public void setAge(String newAge) {
		...
		age = newAge;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Query_metamodelPackage.PATIENT__AGE, oldAge, age));
	}
	...
	public void setSex(String newSex) {
		...
		sex = newSex;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Query_metamodelPackage.PATIENT__SEX, oldSex, sex));
	}
	...
	public void setQuantity(int newQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Query_metamodelPackage.PATIENT__QUANTITY, oldQuantity,
					quantity));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case Query_metamodelPackage.PATIENT__AGE:
			return getAge();
		case Query_metamodelPackage.PATIENT__SEX:
			return getSex();
