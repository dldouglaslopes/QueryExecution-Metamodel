 ...
 *   <li>{@link QueryMetamodel.impl.QFlowImpl#getPathway <em>Pathway</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QFlowImpl extends EMethodImpl implements QFlow {
	...
	public NotificationChain basicSetPathway(Pathway newPathway, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Query_metamodelPackage.QFLOW__PATHWAY, oldPathway, newPathway);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newPathway != pathway) {
			...
			if (pathway != null)
				msgs = ((InternalEObject) pathway).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Query_metamodelPackage.QFLOW__PATHWAY, null, msgs);
			if (newPathway != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Query_metamodelPackage.QFLOW__PATHWAY, newPathway,
					newPathway));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case Query_metamodelPackage.QFLOW__PATHWAY:
