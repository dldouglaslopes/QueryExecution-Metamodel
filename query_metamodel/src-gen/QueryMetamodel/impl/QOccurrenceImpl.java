 ...
 * </p>
 * <ul>
 *   <li>{@link QueryMetamodel.impl.QOccurrenceImpl#getName <em>Name</em>}</li>
 *   <li>{@link QueryMetamodel.impl.QOccurrenceImpl#getOccurrence <em>Occurrence</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QOccurrenceImpl extends EMethodImpl implements QOccurrence {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Query_metamodelPackage.QOCCURRENCE__NAME, oldName,
					name));
	}
	...
	public EList<Occurrence> getOccurrence() {
		if (occurrence == null) {
			occurrence = new EObjectContainmentEList<Occurrence>(Occurrence.class, this,
					Query_metamodelPackage.QOCCURRENCE__OCCURRENCE);
		}
		return occurrence;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case Query_metamodelPackage.QOCCURRENCE__OCCURRENCE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Query_metamodelPackage.QOCCURRENCE__NAME:
			return getName();
		case Query_metamodelPackage.QOCCURRENCE__OCCURRENCE:
