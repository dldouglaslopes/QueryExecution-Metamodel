 ...
 * </p>
 * <ul>
 *   <li>{@link QueryMetamodel.impl.ABooleanImpl#isValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ABooleanImpl extends AnswerImpl implements ABoolean {
	...
	public void setValue(boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Query_metamodelPackage.ABOOLEAN__VALUE, oldValue,
					value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Query_metamodelPackage.ABOOLEAN__VALUE:
			return isValue();
		}
